...
public class Interfaz {
	...
	public void iniciarSistema() {
		...
		/* CAMPOS PARA TEXTO */
		textoValorUno = new JTextField("Valor 1");
		textoValorUno.setBounds(120,25,60,30); //x axis, y axis, width, height
		ventana.add(textoValorUno);

		textoValorDos = new JTextField("Valor 2");
		textoValorDos.setBounds(350,25,60,30); //x axis, y axis, width, height
		ventana.add(textoValorDos);

		textoResultado = new JTextField("Resultado");
		...
		botonAreaTriangulo.addActionListener(
			new ActionListener() {
